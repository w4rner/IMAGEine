...
to validate that you have gathered good training data.
...
def cache_bottlenecks(sess, image_lists, image_dir, bottleneck_dir,
  ...
  Because we're likely to read the same image multiple times it can speed things
  up a lot if we calculate the bottleneck layer values once for each image during
...
def get_random_cached_bottlenecks(sess, image_lists, how_many, category,
  ...
  This function can retrieve the cached
